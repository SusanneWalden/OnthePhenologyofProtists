---
title: "Plot alpha diversity indices grouped by season in a boxplot"
...
```{r CercozoaAlphaBoxPlotSpring, out.width = "50%", dpi=300, warning=FALSE}
#richness
...
```{r CercozoaAlphaBoxPlotAutumn, out.width = "50%", dpi=300, warning=FALSE}
#richness
