...
a = ggplot(df1, aes(x = Microhabitat, y = richness, fill = Microhabitat)) + 
  ...
  geom_text(data = TukeyLetters_richness, aes(label = groups), y = 580,size=3.5)+
  scale_fill_manual(values = c("#800000","#9A6324","#8B8989","#4363d8","#A8ACFF","#BF6692","#FFE4B5","#FF944D","#138F6A"),
                    limits = c("Soil","Leaf Litter","Arboreal Soil","Hypnum","Orthotrichum","Bark","Lichen","Deadwood","Fresh Leaves")) + 
...
<img src="AllSeasons_Pooled_files/figure-markdown_github/CercozoaAlphaBoxPlotSpring-1.png" width="50%" /> Now, repeat all the steps for autumn samples:
...
e = ggplot(df2, aes(x = Microhabitat, y = shannon, fill = Microhabitat)) + 
  ...
  geom_boxplot(show.legend = F) +
  coord_cartesian(ylim = c(1, 6))+
  geom_text(data = TukeyLetters_shannon, aes(label = groups), y = 5.05,size=3.5)+
  scale_fill_manual(values = c("#800000","#9A6324","#8B8989","#4363d8","#A8ACFF","#BF6692","#FFE4B5","#FF944D","#138F6A"),
                    limits = c("Soil","Leaf Litter","Arboreal Soil","Hypnum","Orthotrichum","Bark","Lichen","Deadwood","Fresh Leaves")) + 
  scale_x_discrete(limits = c("Soil","Leaf Litter","Arboreal Soil","Hypnum","Orthotrichum","Bark","Lichen","Deadwood","Fresh Leaves")) + 
  theme_minimal() + 
...
<img src="AllSeasons_Pooled_files/figure-markdown_github/CercozoaAlphaBoxPlotAutumn-1.png" width="50%" />
...
![](AllSeasons_Pooled_files/figure-markdown_github/unnamed-chunk-1-1.png)

``` r
#save plot
#ggsave("BoxplotSeason_300_336x252.jpeg", plot = combi, 
#      device = "jpeg", dpi = 300, width = 336, height = 252, 
#       units = "mm")
#ggsave("BoxplotSeason_600_336x252.pdf", plot = combi, 
#       device = "pdf", dpi = 600, width = 336, height = 252, 
#       units = "mm")
#ggsave("BoxplotSeason600_336x252.tif", plot = combi, 
#       device = "tiff", dpi = 600, width = 336, height = 252, 
#       units = "mm")
#ggsave("BoxplotSeason_600_336x252.png", plot = combi, 
