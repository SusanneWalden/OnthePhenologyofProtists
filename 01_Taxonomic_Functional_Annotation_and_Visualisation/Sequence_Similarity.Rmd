...
In the next step we aggregate all reads depending on the percentage of their sequence similarity and
expand the table to make it readable for *geom_histogram*.

```{r Prepare reads, warning=FALSE, message=FALSE}
...
```{r Plot reads, warning=FALSE, message=FALSE}
...
```{r Plot OTUs, warning=FALSE, message=FALSE}
