...
```{r aggregate table, warning=FALSE, message=FALSE}
...
```
## ggplot
```{r Plot RDA, fig.width=9, fig.height=6, dpi= 300, warning=FALSE, message=FALSE}
...
```{r combine Plots, fig.width=16, dpi=600, warning=FALSE, message=FALSE, echo=FALSE}
